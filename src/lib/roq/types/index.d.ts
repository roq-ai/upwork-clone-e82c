...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'application' | 'company' | 'job' | 'user';
  ...
  interface jobFieldRefs {
    ...
    readonly status: FieldRef<'job', 'Boolean'>;
  ...
  > extends Prisma.PrismaPromise<T> {
    ...
    job<T extends user$jobArgs<ExtArgs> = {}>(
      args?: Subset<T, user$jobArgs<ExtArgs>>,
  ...
  export type jobScalarWhereWithAggregatesInput = {
    ...
    status?: BoolWithAggregatesFilter<'job'> | boolean;
  ...
  export type userUpdateOneRequiredWithoutJobNestedInput = {
    ...
    connect?: userWhereUniqueInput;
    update?: XOR<
      XOR<userUpdateToOneWithWhereWithoutJobInput, userUpdateWithoutJobInput>,
      userUncheckedUpdateWithoutJobInput
    >;
  };
  ...
  export type jobCreateNestedManyWithoutUserInput = {
    create?:
      | XOR<jobCreateWithoutUserInput, jobUncheckedCreateWithoutUserInput>
