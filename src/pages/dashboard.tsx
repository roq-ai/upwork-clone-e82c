...
import { useRoqPlatformUserProfiles, useJobCount, useApplicationCount } from 'lib/roq';
...
function DashboardPage() {
  ...
  const jobStat = useJobCount();

  const applicationStat = useApplicationCount();
