...
import { useApplicationFindFirst, useRoqClient } from 'lib/roq';
...
function ApplicationViewPage() {
  ...
  const queryParams = useMemo<{ include: { job: boolean; user: boolean } }>(
    () =>
  ...
  const { data, error, isLoading } = useApplicationFindFirst(queryParams, {}, { disabled: !id });
